...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/slaker/Public/admin/css/unicorn.login.css" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head>
    <body>
        <div id="logo">
            <img src="/slaker/Public/admin/img/logo.png" alt="" />
        </div>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="<?php echo U('Index/Index');?>" method="post"/>
        ...
        <script src="/slaker/Public/admin/js/unicorn.login.js"></script> 
    </body>
</html>